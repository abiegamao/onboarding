...
export function OnboardingProgress({
    ...
    return (
        <div className="relative overflow-clip rounded-2xl border border-border/50 bg-card">
            {/* Top section */}
            <div className="relative px-5 pt-5 pb-4">
                ...
                <div className="relative z-10 mb-4 flex items-center justify-between">
                    <div>
                        <p className="mb-0.5 font-mono text-[9px] tracking-[3px] text-muted-foreground uppercase">
                            Pathway Progress
                        </p>
                    ...
                    <div className="text-right">
                        <p
                            ...
                            style={{
                                backgroundImage:
                                    "linear-gradient(135deg, var(--primary), #f1ddb0)",
                                backgroundClip: "text",
                ...
                <div className="relative h-2.5 overflow-hidden rounded-full bg-primary/10">
                    <div
                        ...
                        style={{
                            width: `${pct}%`,
                            backgroundImage:
                                "linear-gradient(90deg, var(--primary), #f1ddb0)",
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="hidden min-w-0 sm:block">
                                <p
                                    className={`truncate font-mono text-[8px] tracking-widest uppercase ${
                                        isActive
                                            ? "text-primary"
                                            : isComplete
                                              ? "text-primary/60"
