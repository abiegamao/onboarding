...
export function RegistrationRadarChart({
    ...
    return (
        <Card className="flex flex-col rounded-2xl border border-[#b6954a]/15 bg-card shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <CardHeader className="pb-2">
                ...
                <CardDescription className="mt-1.5 text-xs text-muted-foreground/70">
                    Weekly volume of inbound clients starting their pathway,
                    mapped across multiple axes.
                </CardDescription>
            </CardHeader>
            <CardContent className="relative flex min-h-[220px] flex-1 flex-col justify-center pb-4">
                {loading ? (
